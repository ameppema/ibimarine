...
MyYearCalendar.CustomeUI(function({monthName, monthId, year, HtmlMonthDays, HtmlWeekDays}) {
    ...
    <div class="bg-old-gold flex justify-between text-white h-11 items-center rounded-t-xl text-xl">
      <div style="width: 2rem; text-align: center; padding-left: 1rem;" data-arrow-prev class="calendar-left-arrow cursor-pointer">
      ...
      <div style="width: 2rem; text-align: center;padding-right: 1rem;" data-arrow-next class="calendar-right-arrow cursor-pointer">
