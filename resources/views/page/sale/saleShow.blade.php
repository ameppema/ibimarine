...
@section('content')
    ...
    <div class="container">
        ...
        <div class="reservation__calendar" id="">
...
<script>
    ...
    const requestOverlayContainer = document.querySelector('#overlay__request_container');
    ...
    requestOverlayContainer.innerHTML = requestOverlay;
