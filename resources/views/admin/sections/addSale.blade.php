...
@include('admin.partials.upload-image')
    ...
    <section class="border block lg:w-[86%] w-3/4 bg-[#E6E6E6] px-5">
        <h2 class="text-[#3c4045] font-bold text-3xl mt-5 ">Página de Venta</h2>
        {{-- Published Boats --}}
        ...
        <div class="border-[#3c4045] border bg-white mt-8 px-5 py-5 rounded-lg mb-5">
            ...
            <p class="text-[#343a40] text-xl font-bold mb-4">Nueva Embarcación de VENTA</p>
            <form method="POST" action="{{route('admin.rent.store')}}" enctype="multipart/form-data">
                ...
                <div class="flex border-[#343a40] p-5 border my-10 flex-wrap justify-between">
                    <div class="w-1/2 flex justify-start">
                      <span class="text-[#343a40] font-bold mr-5">Precio de venta</span>
                      <input name="sale_price" value="" type="text" value="{{old('sale_price')}}"
                    ...
                    <div class="hidden w-1/2 flex justify-start">
                      <span class="text-[#343a40] font-bold mr-5">Es venta</span>
                      <input name="is_sale" value="1" type="text" value="{{old('is_sale')}}"
                        class="border-[#343a40] w-7/12 text-gray-700 appearance-none leading-tight font-bold border py-[6px] rounded-md  pl-2 outline-none ">
                    </div>
                </div>

                <div class="hidden border-[#343a40] p-5 border my-10 flex-wrap justify-between">
                  <div class="w-1/2 flex justify-start">
                    <span class="text-[#343a40] font-bold mr-5">Precio Temporada Baja</span>
                    <input name="low_season_price" type="text" value="0"
                      class="border-[#343a40] w-7/12 text-gray-700 appearance-none leading-tight font-bold border py-[6px] rounded-md  pl-2 outline-none ">
                  </div>
