...
<head>
    ...
    <style>
        ...
        h2.active {
        color: #0d0d0d;
        border-bottom: 2px solid #AAA173;
        }
        ...
        text-transform: uppercase;
        font-size: 13px;
        -webkit-box-shadow: 0 10px 30px 0 rgb(170 161 115 / 25%);
        box-shadow: 0 10px 30px 0 rgb(170 161 115 / 25%);
...
<body>
    ...
    <div class="wrapper" data-class="fadeInDown">
        <div id="formContent">
          <!-- Tabs Titles -->
          ...
          <!-- Icon -->
          <div data-class="fadeIn first">
            <img src="./img/logoibimarine.png" id="icon" alt="User Icon" />
          </div>
