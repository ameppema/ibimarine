...
@include('admin.partials.errors')
    ...
    <section class="border block lg:w-[86%] w-3/4 bg-[#E6E6E6] px-5">
      ...
      <div class="border-[#3c4045] border bg-white mt-8 px-5 py-5 rounded-lg mb-5">
        <p class="text-[#343a40] text-xl font-bold mb-4">Listado de Noticias</p>
        <div class="grid grid-cols-3 gap-4 mt-5">
          @foreach ($news as $new)              
          <article class="flex border border-[#343a40] p-2 gap-2 rounded-lg">
            <img src="/storage/{{$new->image}}" alt="Ibimarine news" class="w-28 object-cover">
            <div class="flex flex-col gap-2 justify-center">
              <p class="text-sm line-clamp-6">{{$new->description}}</p>
              <div class="flex items-center justify-center gap-4 ">
                ...
                <form method="POST" action="{{route('admin.news.delete', $new)}}"> @csrf @method('DELETE')
                  <button><i
          ...
          <div class="flex mt-10 justify-between">
            ...
            <div class="w-4/12 ">
              <div class="flex items-center mb-3">
                ...
                <span class="text-[#343a40] font-bold mx-5">Texto de la Noticia</span>
              </div>
            ...
            <div class="w-4/12 ">
              <div class="flex items-center mb-3">
                ...
                <span class="text-[#343a40] font-bold mx-5">News Text</span>
              </div>
